---
title: "[Castorus] maison - 5 pièces 140m²"
outline: deep
---

# maison - 5 pièces 140m²
...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">433 000 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
    <div class="card-label">Surface</div>
    <div class="card-val">140 m²</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">🚪</div>
...
```text
Annonce Castorus détectée il y a 16 jour(s). Titre : Maison 5 pièces 140 m². Prix : 433 000 €. Surface : 140m².
```
...
<div class="detail-actions">
  ...
  <a href="https://www.castorus.com/annonce/brest-29200/ref170818337" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Castorus ↗</a>
</div>
