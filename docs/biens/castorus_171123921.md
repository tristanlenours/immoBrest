---
title: "[Castorus] maison - 8 pièces 145m²"
outline: deep
---

# maison - 8 pièces 145m²
...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">307 400 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
    <div class="card-label">Surface</div>
    <div class="card-val">145 m²</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">🚪</div>
    <div class="card-label">Pièces / Type</div>
    <div class="card-val">- Pièces : 8 pièces (Maison)</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📍</div>
...
```text
Annonce Castorus détectée il y a 11 jour(s). Titre : Maison 8 pièces 145 m². Prix : 307 400 €. Surface : 145m².
```
...
<div class="detail-actions">
  ...
  <a href="https://www.castorus.com/annonce/brest-29200/ref171123921" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Castorus ↗</a>
</div>
