---
title: "[Castorus] appartement - 8 pièces 146m²"
outline: deep
---

# appartement - 8 pièces 146m²
...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">329 900 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
    <div class="card-label">Surface</div>
    <div class="card-val">146 m²</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">🚪</div>
    <div class="card-label">Pièces / Type</div>
    <div class="card-val">- Pièces : 8 pièces (Appartement)</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📍</div>
...
```text
Annonce Castorus détectée il y a 13 jour(s). Titre : Appartement 8 pièces 146 m². Prix : 329 900 €. Surface : 146m².
```
...
<div class="detail-actions">
  ...
  <a href="https://www.castorus.com/annonce/brest-29200/ref171015860" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Castorus ↗</a>
</div>
