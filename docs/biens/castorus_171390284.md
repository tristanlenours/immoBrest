---
title: "[Castorus] appartement - 4 pièces 88m²"
outline: deep
---

# appartement - 4 pièces 88m²
...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">320 000 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
    <div class="card-label">Surface</div>
    <div class="card-val">88 m²</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">🚪</div>
...
```text
Annonce Castorus détectée il y a 5 jour(s). Titre : Bien immobilier 4 pièces 88 m². Prix : 320 000 €. Surface : 88m².
```
...
<div class="detail-actions">
  ...
  <a href="https://www.castorus.com/annonce/brest-29200/ref171390284" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Castorus ↗</a>
</div>
