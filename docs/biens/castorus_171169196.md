---
title: "[Castorus] appartement - 4 pièces 92m²"
outline: deep
---

# appartement - 4 pièces 92m²
...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">365 000 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
    <div class="card-label">Surface</div>
    <div class="card-val">92 m²</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">🚪</div>
...
```text
Annonce Castorus détectée il y a 10 jour(s). Titre : Bien immobilier 4 pièces 92 m². Prix : 365 000 €. Surface : 92m².
```
...
<div class="detail-actions">
  ...
  <a href="https://www.castorus.com/annonce/brest-29200/ref171169196" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Castorus ↗</a>
</div>
