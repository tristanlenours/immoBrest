---
title: "[Leboncoin] appartement Saint-Michel - 5 pièces 123m²"
outline: deep
---

# appartement Saint-Michel - 5 pièces 123m²
...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">305 000 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
    <div class="card-label">Surface</div>
    <div class="card-val">123 m²</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">🚪</div>
...
* **Prestations supplémentaires** : Vendeur: Professionnel (FT Breizh - Brest Linois)
...
![Capture d'Écran de l'Annonce](/screenshots/leboncoin_3172038629.png)
...
<div class="detail-actions">
  ...
  <a href="https://www.leboncoin.fr/ad/ventes_immobilieres/3172038629" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Leboncoin ↗</a>
</div>
