---
title: "[Castorus] appartement Saint-Marc - 119m²"
outline: deep
---

# appartement Saint-Marc - 119m²
...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">381 600 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
    <div class="card-label">Surface</div>
    <div class="card-val">119 m²</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">🚪</div>
    <div class="card-label">Pièces / Type</div>
    <div class="card-val">- Pièces : Non spécifié (Appartement)</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📍</div>
