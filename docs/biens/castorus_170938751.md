---
title: "[Castorus] maison - 4 pièces 86m²"
outline: deep
---
...
<div class="grid-stats">
  ...
  <div class="grid-stat-card">
    ...
    <div class="card-val">- Pièces : 4 pièces (Maison)</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📍</div>
...
```text
Annonce Castorus détectée il y a 14 jour(s). Titre : Maison 4 pièces 86 m². Prix : 319 900 €. Surface : 86m².
```
...
<div class="detail-actions">
  ...
  <a href="https://www.castorus.com/annonce/brest-29200/ref170938751" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Castorus ↗</a>
</div>
