---
title: "[Castorus] appartement - 4 pièces 97m²"
outline: deep
---

# appartement - 4 pièces 97m²
...
<div class="grid-stats">
  ...
  <div class="grid-stat-card">
    ...
    <div class="card-val">Brest (Brest (Brest))</div>
  </div>
</div>
...
```text
Annonce Castorus détectée il y a 11 jour(s). Titre : Bien immobilier 4 pièces 97 m². Prix : 439 000 €. Surface : 97m².
```
...
<div class="detail-actions">
  ...
  <a href="https://www.castorus.com/annonce/brest-29200/ref171105064" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Castorus ↗</a>
</div>
