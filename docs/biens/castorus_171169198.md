---
title: "[Castorus] appartement - 4 pièces 100m²"
outline: deep
---

# appartement - 4 pièces 100m²
...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">306 000 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
...
```text
Annonce Castorus détectée il y a 10 jour(s). Titre : Bien immobilier 4 pièces 100 m². Prix : 306 000 €. Surface : 100m².
```
