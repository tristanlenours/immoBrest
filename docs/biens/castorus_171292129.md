---
title: "[Castorus] appartement - 4 pièces 101m²"
outline: deep
---

# appartement - 4 pièces 101m²
...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">305 620 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
    <div class="card-label">Surface</div>
    <div class="card-val">101 m²</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">🚪</div>
...
```text
Annonce Castorus détectée il y a 8 jour(s). Titre : Bien immobilier 4 pièces 101 m². Prix : 305 620 €. Surface : 101m².
```
...
<div class="detail-actions">
  ...
  <a href="https://www.castorus.com/annonce/brest-29200/ref171292129" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Castorus ↗</a>
</div>
