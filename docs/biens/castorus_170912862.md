...
<div class="grid-stats">
  <div class="grid-stat-card">
    ...
    <div class="card-val">363 000 €</div>
  </div>
  <div class="grid-stat-card">
    <div class="card-icon">📐</div>
...
```text
Annonce Castorus détectée il y a 15 jour(s). Titre : Maison 5 pièces 115 m². Prix : 363 000 €. Surface : 115m².
```
...
<div class="detail-actions">
  ...
  <a href="https://www.castorus.com/annonce/brest-29200/ref170912862" target="_blank" rel="noopener" class="action-btn original-btn">Consulter sur Castorus ↗</a>
</div>
